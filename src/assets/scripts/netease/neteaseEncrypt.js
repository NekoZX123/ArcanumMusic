...
function getNeteaseEncrypt(data) {
    const result = asrsea(data, e, f, g);

    return result;
}

// console.log(getNeteaseEncrypt('{"id":"2630217057","lv":-1,"tv":-1,"csrf_token":""}'));
...
// console.log(JSON.stringify(asrsea(d, e, f, g)));
