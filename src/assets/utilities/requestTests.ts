...
// @ts-ignore TS6133
import { getKugouAlbum, getKugouArtist, getKugouLyrics, getKugouSearchResult, getKugouSongInfo, getKugouSonglink } from '../scripts/kugou/kugouRequest.ts';
...
function testKugouRequests() {
    ...
    //     .then((response) => {
    //         console.log(response.data);
    //     });getKugouSongInfo('8y83yg8c', { KuGoo: kugouUser })
    //     .then((response) => {
    //         console.log(response.data);
    //     });
    ...
    //     });
    // 
    getKugouAlbum('79746522', { KuGoo: kugouUser })
        .then((response) => console.log(response.data));
    getKugouArtist(7230076)
        .then((response) => console.log(response.data));
}
// 测试请求 (QQ音乐)
